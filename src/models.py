...
from tensorflow.keras.layers import Conv3D, MaxPool3D, Concatenate, UpSampling2D
from tensorflow_addons.layers import SpectralNormalization 
from tensorflow.keras.metrics import Mean

import src.losses as loss
from src.utils import get_layer_number, to_tuple, to_3Dtuple
from src.blocks import Transpose2D_block, Upsample2D_block, Conv2DBlock, SpectralNormalizationConv2D
from src.blocks import Transpose3D_block, Upsample3D_block, Conv3DBlock, SpectralNormalizationConv3D
from src.blocks import down_block, attention_block, handle_block_names, handle_activation_names
from src.helpers import conv_block, z_mu_sigma, attention_block, concatenation_block
...
class ProbUNet2Prior_Y1Y2GAN(keras.Model):
    ...
    def compile(self, prior_opt, posterior_opt, d_optimizer, g_optimizer, d_loss_fn, g_loss_fn, batch_size):
...
def DiscriminatorSNGAN(
    ...
    if type == '2D':
        ...
        model = build_discriminator_sngan3D(
            encoder_filters=encoder_filters,
            downsample_rates=downsample_rates,
            filter_sizes=filter_sizes,
            n_downsamples=n_downsamples,
        ...
        model._name = model_name = 'DiscriminatorSNGAN3D'
